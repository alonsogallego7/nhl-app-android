...
@Database(
    entities = [ConferenceEntity::class, DivisionEntity::class, TeamEntity::class, TeamDetailEntity::class, VenueEntity::class, PlayerEntity::class, PersonEntity::class, PositionEntity::class],
